...
import com.pulkit.musicplayer.manager.MusicPreferance;
import com.pulkit.musicplayer.manager.NotificationManager;
import com.pulkit.musicplayer.widget.ObservableScrollView;
import com.pulkit.musicplayer.widget.ObservableScrollViewCallbacks;
import com.pulkit.musicplayer.widget.ScrollState;
import com.pulkit.musicplayer.widget.ScrollUtils;
...
import com.pulkit.musicplayer.widget.ExpandableHeightListView;
import com.pulkit.musicplayer.widget.PlayPauseView;
import com.pulkit.musicplayer.widget.Slider;
import com.pulkit.musicplayer.widget.SlidingUpPanelLayout;
 ...
 * @date 31/7/2016
 */
public class AlbumArtistDetails extends ActionBarActivity implements View.OnClickListener, ObservableScrollViewCallbacks, Slider.OnValueChangedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = AlbumArtistDetails.this;
        theme();
    ...
    private void initialize() {
        ...
        // Setup RecyclerView inside layout_navigation_drawer
    ...
    private void getBundleValuse() {
        ...
        if (tagFor == MediaControllers.SonLoadFor.Gener.ordinal()) {
            loadGenresSongs(id);
        } else if (tagFor == MediaControllers.SonLoadFor.Album.ordinal()) {
            loadAlbumSongs(id);
        } else if (tagFor == MediaControllers.SonLoadFor.Artis.ordinal()) {
            loadArtistSongs(id);
        } else {
        }
    ...
    private void loadAlbumSongs(long id) {
        ...
        mMediaControllers.loadMusicList(context, id, MediaControllers.SonLoadFor.Album, "");
    ...
    private void loadArtistSongs(long id) {
        ...
        mMediaControllers.loadMusicList(context, id, MediaControllers.SonLoadFor.Artis, "");
    }

    private void loadGenresSongs(long id) {
        MediaControllers mMediaControllers = MediaControllers.getInstance();
        MediaControllers.setPhonemediacontrolinterface(new MediaControllers.PhoneMediaControlINterface() {
        ...
        mMediaControllers.loadMusicList(context, id, MediaControllers.SonLoadFor.Gener, "");
    }
    ...
    private void initiSlidingUpPanel() {
        ...
        img_share = (ImageView) findViewById(R.id.bottombar_img_share);
